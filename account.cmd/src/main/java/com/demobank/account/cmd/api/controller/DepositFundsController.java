...
@RestController
@RequestMapping("/v1/depositFunds")
public class DepositFundsController {
    ...
    public ResponseEntity<BaseResponse> depositFunds(@PathVariable(value = "id") String id,
        ...
        try {
            ...
            return ResponseEntity.ok(new BaseResponse(HttpStatus.OK.toString(), "bank account deposit funds request completed successfully!"));
            ...
            final var safeErrMsg = MessageFormat.format("error while processing request to deposit funds to bank account for id - {0}.", id);
